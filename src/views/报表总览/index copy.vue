<template>
  <div class="report-container">
    ...
    <!-- 报表分类网格 -->
    <transition-group name="fade" tag="div" class="categories-grid">
      <el-card class="category-card" v-for="category in filteredCategories" :key="category.id">
          ...
          <div class="report-list">
            <div class="report-item" v-for="report in category.reports" :key="report.id">
              ...
              <div class="report-actions">
                ...
                <el-button size="mini" :icon="report.favorited ? 'el-icon-star-on' : 'el-icon-star-off'" :type="report.favorited ? 'warning' : ''" @click="toggleFavorite(report)" class="favorite-btn">
...
.category-card ::v-deep .el-card__header {
  padding: 0;;
}
.category-header {
  display: flex;
