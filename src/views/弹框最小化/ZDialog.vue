    ...
    >
      <div v-show="!isminimize" slot="title" class="medium" @dblclick="resetFull">
        ...
        <div class="icons">
          ...
          <i title="全屏" :class="isfullscreen ? 'el-icon-copy-document' : 'el-icon-full-screen'" style="font-size: 24px" @click="IsFullscreen"></i>
      ...
      <div v-show="isminimize" slot="title" class="horn" @dblclick="resetFull">
        ...
        <div class="icons">
          <i title="还原" class="el-icon-copy-document" style="font-size: 24px" @click="minimize"></i>
          <i title="关闭" class="el-icon-close" style="font-size: 24px" @click="closeDialog"></i>
        </div>
      </div>
